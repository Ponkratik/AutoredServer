...
class Ride(
    ...
    @Basic @Column(name = "date_start") private var dateStart: Date = Date(),
    @Basic @Column(name = "date_end") private var dateEnd: Date = Date(),
    @Basic @Column(name = "date_signed_lessor") private var dateSignedLessor: Date = Date(0),
    @Basic @Column(name = "date_signed_lessee") private var dateSignedLessee: Date = Date(),
